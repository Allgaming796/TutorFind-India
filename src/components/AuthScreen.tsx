  ...
  return (
    <div className="min-h-screen bg-neutral-50 flex items-center justify-center p-4">
      <motion.div 
        ...
        className="w-full max-w-md bg-white rounded-xl border-2 border-black p-8 shadow-[8px_8px_0px_0px_rgba(17,24,39,1)] relative overflow-hidden"
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 bg-black hover:bg-neutral-900 text-white font-bold font-display uppercase tracking-widest text-xs rounded-lg transition-all border-2 border-black flex items-center justify-center gap-2 cursor-pointer shadow-[2px_2px_0px_0px_rgba(17,24,39,1)] active:translate-x-[1px] active:translate-y-[1px] active:shadow-none"
          >
            {loading ? (
